...
\caption{The VSGs and RGs (Part 1).}
\label{fig:deltaencoding1}
\end{figure*}
...
\end{subfigure}
\caption{The VSGs and RGs (Part 2).}
\label{fig:deltaencoding2}
\end{figure*}
...
At the iteration $t$, from the subregion on the edge \Edge{a_0}{a_1} as shown in Figure~\ref{fig:deltaencoding1}(a), we have $(a_0\equiv a_1)@\overline{[i_0:i^t_1-1]}$.
